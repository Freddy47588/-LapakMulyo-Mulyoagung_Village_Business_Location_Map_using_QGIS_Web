...
map.getView().fit([12532820.213883, -883954.666332, 12533068.452202, -883823.764645], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Peta Persebaran Lokasi Bisnis di Jalan MulyoAgung</h2>';
        return titleElement;
    })(),
...
var searchLayer = new SearchLayer({
    layer: lyr_LokasiBisnisMulyoAgung_5,
    colName: 'nama',
    zoom: 10,
    collapsed: true,
    map: map,
